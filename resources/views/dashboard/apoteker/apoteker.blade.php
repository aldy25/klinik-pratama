...
<div class="card shadow mb-4">
  ...
  <div class="col-2 mt-3">
    <a href="/apoteker/create" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Tambah</a>
  </div>
  <div class="card-body">
        ...
        <table class="table table-bordered dt-responsive nowrap" id="dataTable" width="100%" cellspacing="0">
         ...
         <tbody>
           ...
           <tr>
            ...
            <td>
              <a href="/apoteker/edit/{{ $apoteker->id }}" class="btn btn-success"><i class="fas fa-edit"></i></a>
                <form action="/apoteker/delete/{{ $apoteker->id }}" method="POST" class="d-inline">
                  @csrf
