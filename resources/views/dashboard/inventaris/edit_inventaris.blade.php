...
<div class="card shadow mb-4">
  <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-success">Edit Data Inventaris</h6>
  </div>
  <div class="card-body">
    <div class="row">
      <div class="col-6">
        <form method="POST" action="/inventaris/update/{{ $inventaris->id }}">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control @error('kondisi') is-invalid  @enderror" id="kondisi" name="kondisi" value="{{ old('kondisi', $inventaris->kondisi) }}">
            @error('kondisi')
            <div class="invalid-feedback">
              {{ $message }}
            </div>    
